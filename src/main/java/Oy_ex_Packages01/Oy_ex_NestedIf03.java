...
Scanner input  = new Scanner(System.in);
      ...
      char firstchar= pswgirdi.charAt(0);
...

        {
                ...
                if (firstchar == 'A') {System.out.println("gecerli pasword");}
                ...
                if (firstchar>='a' && firstchar<='z')
                   {
                       if (firstchar == 'z')  { System.out.println("gecerli pasword");

                   } else { System.out.println("gecersiz pasword kucuk ama z degil");}
